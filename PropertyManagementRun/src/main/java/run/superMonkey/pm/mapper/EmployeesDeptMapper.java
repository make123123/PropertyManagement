...
public interface EmployeesDeptMapper {
	//增
    public int insertSelective(EmployessDeptEntity record)throws Exception;
    //删
    public int deleteByPrimaryKey(Integer deptno)throws Exception;
    //改
    public int updateByPrimaryKeySelective(EmployessDeptEntity record)throws Exception;
    //查
