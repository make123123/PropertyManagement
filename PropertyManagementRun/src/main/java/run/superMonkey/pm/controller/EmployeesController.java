...
public class EmployeesController {
	...
	public ResultMessage<EmployessEntity>delete(Integer empid)throws Exception{
		es.delete(empid);
		return new ResultMessage<EmployessEntity>("OK","删除员工成功");
		}
	@RequestMapping("/modify")
	public ResultMessage<EmployessEntity> modify(
			@RequestParam(required = false)Integer empid,
			@RequestParam(required = false)Integer deptno,
			@RequestParam(required = false)String empname,
			@RequestParam(required = false)String sex,
		...
		em.setWx(wx);
		es.update(em);
		return new ResultMessage<EmployessEntity>("OK","修改员工成功");
